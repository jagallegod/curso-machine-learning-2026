...
Profesor: Jorge Gallego \ $|$ \ Banco Interamericano de Desarrollo \ $|$ \ \href{mailto:jagallegod@gmail.com}{jagallegod@gmail.com}
\end{center}
...
\begin{enumerate}[label=\Roman*., leftmargin=*, itemsep=4pt]
  \item \textbf{Introducción, KNN y Naive Bayes}
  \begin{enumerate}[label=\alph*.]
    \item Introducción al aprendizaje de máquinas
    \item Clasificación usando vecinos más cercanos (KNN)
    \item Aprendizaje probabilístico: Naive Bayes
  \end{enumerate}

  \item \textbf{SVM, árboles de decisión y random forests}
  \begin{enumerate}[label=\alph*.]
    \item Support Vector Machines
    \item Árboles de decisión
    \item Bagging y random forests
  \end{enumerate}

  \item \textbf{Regresión, Ridge y Lasso}
  \begin{enumerate}[label=\alph*.]
  ...
  \item \textbf{Aprendizaje profundo (deep learning)}
  \begin{enumerate}[label=\alph*.]
    \item Introducción
...
\begin{enumerate}[leftmargin=*, itemsep=4pt]
  \item \textbf{Quiz (33\%).} Durante la sesión 5. Examen individual, a la antigua (lápiz y papel, sin ningún recurso), enfocado en evaluar la comprensión de los conceptos principales de los modelos vistos en el curso.
  \item \textbf{Proyecto / \textit{policy report} (33\%).} Trabajo para la casa: cada estudiante aplica las herramientas del curso a un problema real de política pública. Debe plantear una pregunta de evaluación/investigación, conseguir una base de datos para responderla, diseñar una estrategia empírica (usando uno o varios de los modelos del curso), implementarla y escribir un reporte de política con los resultados. Aquí sí se puede usar todo: material del curso, datos externos, LLMs, etc.
  \item \textbf{Sustentación (34\%).} Defensa virtual (videollamada) del proyecto, unos días después de la entrega, para verificar que cada estudiante comprende a fondo el trabajo entregado.
\end{enumerate}

\section*{5. Políticas del curso}
